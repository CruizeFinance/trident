...
app.conf.beat_schedule = {
    ...
    "open_order_on_dydx": {"task": "open_eth_order_on_dydx", "schedule": 30.0},
    "close_order_on_dydx": {"task": "close_eth_order_on_dydx", "schedule": 30.0},
    "open_btc_order_on_dydx": {"task": "open_btc_order_on_dydx", "schedule": 30.0},
    "close_btc_order_on_dydx": {"task": "close_btc_order_on_dydx", "schedule": 30.0},
