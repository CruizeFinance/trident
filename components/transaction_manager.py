...
class TransactionManager:
    ...
    def transaction_price(self, max_wait_seconds, sample_size, probability):
    ...
    def build_transaction(self):
        gas_price = self.transaction_price(MAX_WAIT_SECONDS, BLOCK_SAMPLE_SIZE, PROBABILITY)
...
if __name__ == "__main__":
    ...
    print(a.transaction_price(60, 2, 100))
